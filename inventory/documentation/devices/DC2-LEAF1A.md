...
| --------- | --------------- | ------------ | --------- |
| DC2_LEAF1 | Vlan4094 | 10.255.252.1 | Port-Channel3 |
...
| Ethernet5 | DC2-L2LEAF1A_Ethernet1 | *trunk | *- | *- | *- | 5 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC2-SPINE1_Ethernet1 | routed | - | 172.31.255.1/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_DC2-SPINE2A_Ethernet1 | routed | - | 172.31.255.3/31 | default | 1500 | false | - | - |
...
!
interface Ethernet2
   description P2P_LINK_TO_DC2-SPINE2A_Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
router bgp 65101
   ...
   neighbor 10.255.251.1 description DC2-LEAF1B
   neighbor 172.31.255.0 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.0 remote-as 65001
   neighbor 172.31.255.0 description DC2-SPINE1_Ethernet1
   neighbor 172.31.255.2 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.2 remote-as 65001
   neighbor 172.31.255.2 description DC2-SPINE2a_Ethernet1
   neighbor 172.31.255.4 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.4 remote-as 65001
   neighbor 172.31.255.4 description DC2-SPINE3_Ethernet1
