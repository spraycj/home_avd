...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC2-LEAF1A_Ethernet5 | routed | - | 172.31.255.4/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_DC2-LEAF1B_Ethernet5 | routed | - | 172.31.255.10/31 | default | 1500 | false | - | - |
...
!
interface Ethernet2
   description P2P_LINK_TO_DC2-LEAF1B_Ethernet5
   no shutdown
   mtu 1500
   no switchport
...
router bgp 65001
   ...
   neighbor 172.31.255.5 description DC2-LEAF1A_Ethernet5
   neighbor 172.31.255.11 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.11 remote-as 65101
   neighbor 172.31.255.11 description DC2-LEAF1B_Ethernet5
   neighbor 192.168.255.3 peer group EVPN-OVERLAY-PEERS
   neighbor 192.168.255.3 remote-as 65101
   neighbor 192.168.255.3 description DC2-LEAF1A
   neighbor 192.168.255.4 peer group EVPN-OVERLAY-PEERS
   neighbor 192.168.255.4 remote-as 65101
   neighbor 192.168.255.4 description DC2-LEAF1B
