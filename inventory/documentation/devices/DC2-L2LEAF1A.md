...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | DC2-LEAF1A_Ethernet5 | *trunk | *- | *- | *- | 1 |
| Ethernet2 | DC2-LEAF1B_Ethernet5 | *trunk | *- | *- | *- | 1 |
...
!
interface Ethernet1
   description DC2-LEAF1A_Ethernet5
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description DC2-LEAF1B_Ethernet5
   no shutdown
   channel-group 1 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | DC2_LEAF1_Po5 | switched | trunk | - | - | - | - | - | - | - |
