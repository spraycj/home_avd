...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.255.0.100/24 | 10.255.0.1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC1-LEAF1A_Ethernet5 | routed | - | 172.31.255.4/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-LEAF1B_Ethernet5 | routed | - | 172.31.255.10/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_LINK_TO_DC1-LEAF2A_Ethernet5 | routed | - | 172.31.255.16/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_LINK_TO_DC1-LEAF2B_Ethernet5 | routed | - | 172.31.255.22/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_DC1-LEAF1A_Ethernet5
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet3
   description P2P_LINK_TO_DC1-LEAF2A_Ethernet5
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet4
   description P2P_LINK_TO_DC1-LEAF2B_Ethernet5
   no shutdown
   mtu 1500
   no switchport
