...
| --------- | ----------- | -----| ------- | -------------- |
| Ethernet48.2000 | Uplink B | l3dot1q | - | 2000 |
| Ethernet48.3000 | Uplink B | l3dot1q | - | 3000 |

#### IPv4

| Interface | Description | Type | Channel Group | IP Address | VRF |  MTU | Shutdown | ACL In | ACL Out |
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC1-SPINE1_Ethernet3 | routed | - | 172.31.255.13/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SPINE2A_Ethernet3 | routed | - | 172.31.255.15/31 | default | 1500 | False | - | - |
| Ethernet48.2000 | Uplink B | l3dot1q | - | 10.6.120.7/28 | TENANTA_OP_ZONE | - | False | - | - |
| Ethernet48.3000 | Uplink B | l3dot1q | - | 10.6.121.2/28 | default | - | False | - | - |
...
!
interface Ethernet2
   description P2P_LINK_TO_DC1-SPINE2A_Ethernet3
   no shutdown
   mtu 1500
   no switchport
...
| Loopback100 | TENANTA_OP_ZONE_VTEP_DIAGNOSTICS | TENANTA_OP_ZONE | 10.255.1.5/32 |
...
| Vlan3009 |  TENANTA_OP_ZONE  |  10.255.251.4/31  |  -  |  -  |  -  |  -  |  -  |
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 1 | 192.168.255.5 | enabled | Ethernet48.3000 <br> | disabled | default | disabled | disabled | - | - | - | - |
| 2 | 192.168.255.5 | enabled | Ethernet48.2000 <br> | disabled | default | disabled | disabled | - | - | - | - |
...
| 10.255.251.5 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | TENANTA_OP_ZONE | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| Tenant_A_APP_Zone | 192.168.255.5:12 | 12:12 | - | - | learned<br>igmp | 130-131 |
| Tenant_A_DB_Zone | 192.168.255.5:13 | 13:13 | - | - | learned<br>igmp | 140-141 |
| Tenant_A_NFS | 192.168.255.5:10161 | 10161:10161 | - | - | learned<br>igmp | 161 |
| Tenant_A_VMOTION | 192.168.255.5:55160 | 55160:55160 | - | - | learned<br>igmp | 160 |
| Tenant_A_WAN_Zone | 192.168.255.5:14 | 14:14 | - | - | learned<br>igmp | 150 |
| Tenant_A_WEB_Zone | 192.168.255.5:11 | 11:11 | - | - | learned<br>igmp | 120-121 |
...
| TENANTA_OP_ZONE | 192.168.255.5:10 | 10:10 | - | - | learned<br>igmp | 110-112 |
...
| TENANTA_OP_ZONE | 192.168.255.5:10 | ospf match external |
...
| ---- | --------------- | ---------- | -------------- | ----------------- | -------------------------- | ----------------------- | ---------------------- | ------------------- | ------- |
| 110 | True | 192.168.255.5 | - | - | - | - | - | - | - |
| 111 | True | 192.168.255.5 | - | - | - | - | - | - | - |
| 112 | True | 192.168.255.5 | - | - | - | - | - | - | - |
| 120 | True | 192.168.255.5 | - | - | - | - | - | - | - |
| 121 | True | 192.168.255.5 | - | - | - | - | - | - | - |
| 130 | True | 192.168.255.5 | - | - | - | - | - | - | - |
| 131 | True | 192.168.255.5 | - | - | - | - | - | - | - |
| 140 | True | 192.168.255.5 | - | - | - | - | - | - | - |
| 141 | True | 192.168.255.5 | - | - | - | - | - | - | - |
| 150 | True | 192.168.255.5 | - | - | - | - | - | - | - |
| 160 | True | 192.168.255.5 | - | - | - | - | - | - | - |
| 161 | True | 192.168.255.5 | - | - | - | - | - | - | - |
...
ip igmp snooping vlan 112 querier address 192.168.255.5
ip igmp snooping vlan 120 querier
ip igmp snooping vlan 120 querier address 192.168.255.5
ip igmp snooping vlan 121 querier
ip igmp snooping vlan 121 querier address 192.168.255.5
ip igmp snooping vlan 130 querier
ip igmp snooping vlan 130 querier address 192.168.255.5
ip igmp snooping vlan 131 querier
ip igmp snooping vlan 131 querier address 192.168.255.5
ip igmp snooping vlan 140 querier
ip igmp snooping vlan 140 querier address 192.168.255.5
ip igmp snooping vlan 141 querier
ip igmp snooping vlan 141 querier address 192.168.255.5
ip igmp snooping vlan 150 querier
ip igmp snooping vlan 150 querier address 192.168.255.5
ip igmp snooping vlan 160 querier
ip igmp snooping vlan 160 querier address 192.168.255.5
ip igmp snooping vlan 161 querier
ip igmp snooping vlan 161 querier address 192.168.255.5
```
...
| -------------- | --------------------- |
| TENANTA_OP_ZONE | 10.255.1.5 |

## Virtual Source NAT Configuration

```eos
!
ip address virtual source-nat vrf TENANTA_OP_ZONE address 10.255.1.5
```
